...
* Método girar_a_direita
    ...
    'Oeste'
"""
# Upercase para indicar uma constante seguindo a Pep 8:
NORTE = 'Norte'
SUL = 'Sul'
LESTE = 'Leste'
OESTE = 'Oeste'

# Motor com incrementação e decrementação de velocidade:
class Motor:
    def __init__(self):
        self.velocidade = 0
    ...
    def frear(self):
        self.velocidade -= 1
        # Valor máximo 0, velocidade 0:
        self.velocidade = max(0, self.velocidade)

class Direcao:
    # Alternativa para em caso de muitos IFs:
